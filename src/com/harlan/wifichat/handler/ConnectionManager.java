...
public class ConnectionManager {
	...
	public ConnectionManager(ConnectionService service) {
		mService = service;
		mApp = (WifiChatApplication)mService.getApplication();
	}
	...
	public int startClientSelector(String host) {
		...
		try {
		    ...
		    mApp.clearMessages();
		    LogTrace.d(TAG, "startClientSelector"," started: " + mClientSocketChannel.socket().getLocalAddress().getHostAddress());
			...
			LogTrace.e(TAG, "startClientSelector"," exception: " + e.toString());
	...
	public int startServerSelector() {
		...
		try {			
		    ...
		    ((WifiChatApplication)mService.getApplication()).setMyAddr(mServerAddr);
	...
	public void onBrokenConn(SocketChannel schannel){
		try{
			...
			LogTrace.e(TAG, "onBrokenConn: ","close channel: " + e.toString());
		}
	}
	...
	public void onFinishConnect(SocketChannel schannel){
		...
		((WifiChatApplication)mService.getApplication()).setMyAddr(mClientAddr);
	}
