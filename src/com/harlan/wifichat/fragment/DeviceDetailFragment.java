...
package com.harlan.wifichat.fragment;
...
import com.harlan.wifichat.service.FileTransferService;
...
public class DeviceDetailFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mApp = (WifiChatApplication)getActivity().getApplication();
    }
...
//                        startActivityForResult(intent, CHOOSE_FILE_RESULT_CODE);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // FileTransferService.
    	if(requestCode==CHOOSE_FILE_RESULT_CODE&&data.getData()!=null){
        ...
        serviceIntent.putExtra(FileTransferService.EXTRAS_GROUP_OWNER_PORT, 8993);
    ...
    public void onConnectionInfoAvailable(final WifiP2pInfo info) {
        ...
        Constants.ServerHostAddress = info.groupOwnerAddress.getHostAddress();
        ...
        if( ! mApp.mIsServer && mApp.mMyAddr == null ){
        	SingleToast.showToast(mApp,"Connect to Server Failed, Please try again...", 2000);
        	LogTrace.d(TAG,  "onConnectionInfoAvailable"," connect to serve failed...try again ! ");
        }else{
        	// hide the connect button and enable start chat button
        	mContentView.findViewById(R.id.btn_connect).setVisibility(View.GONE);
        	mContentView.findViewById(R.id.btn_start_client).setVisibility(View.VISIBLE);
        	LogTrace.d(TAG, "onConnectionInfoAvailable"," socket connection established, show start chat button ! ");
        }
    }
    ...
    public void resetViews() {
    	LogTrace.d(TAG, "resetViews"," detail frag dismiss progress dialog and clear views");
    	if (progressDialog != null && progressDialog.isShowing()) {
            progressDialog.dismiss();
        }
    ...
    public static class FileServerAsyncTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            try {
                ServerSocket serverSocket = new ServerSocket(8993);
